...
> = {
  ...
  anytime_fitness: { label: "Anytime Fitness", imageUrl: "/anytimefitness.png" },
}
...
function createMarkerElement(location: LocationRow) {
  ...
  if (location.type === "anytime_fitness") {
    el.style.backgroundImage = "url('/anytimefitness.png')"
    el.style.backgroundSize = "contain"
    el.style.backgroundRepeat = "no-repeat"
    el.style.backgroundPosition = "center"
    return el
...
export default function Map() {
  ...
  const activeLegendItems = useMemo(() => {
    ...
    if (enabledTypes.anytime_fitness) {
      items.push({ label: "Anytime Fitness", imageUrl: "/anytimefitness.png" })
    }
